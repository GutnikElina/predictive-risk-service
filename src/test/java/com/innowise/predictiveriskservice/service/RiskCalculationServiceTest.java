...
class RiskCalculationServiceTest {
    ...
    private RiskScoreCalculationDto data(double delay, double weather, double vendorHistory, double documentErrors) {
        return new RiskScoreCalculationDto(UUID.randomUUID(), delay, weather, vendorHistory, documentErrors);
    }
    ...
    void calculateRiskScore_scoreAboveMax_throwsIllegalRiskScoreException() {
        ...
        var testData = data(1.0, 1.0, 1.0, 1.0);

        assertThatThrownBy(() -> riskCalculationService.calculateRiskScore(testData))
    ...
    void calculateRiskScore_zeroDivisor_throwsIllegalRiskScoreException() {
        ...
        var testData = data(0.0, 1.0, 1.0, 1.0);
